const Simple = ({ pagepart }) => {
  ...
  let local = {}
  local.topLevelClasses = 'row py-5'
  //local.topLevelClasses = 'row py-5 text-bg-'+pagepart.PagePartColorTheme.toLowerCase()
  //if(pagepart.PagePartLayout.search('Center') > 0) local.topLevelClasses += ' text-center'

  return (
    <div className={local.topLevelClasses}>
      <div className='col'>
